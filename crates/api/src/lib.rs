...
pub fn create_router(state: AppState) -> Router {
    let api = Router::new()
        ...
        .route(
            "/trees/:tree_id/research-queries",
            get(handlers::external_research::list_queries_for_tree),
        )
        .route(
            "/trees/:tree_id/research-queries/:query_id",
            get(handlers::external_research::get_query_tree)
                .delete(handlers::external_research::delete_query_tree),
        )
        .route(
            "/trees/:tree_id/research-queries/:query_id/run",
            post(handlers::external_research::run_query_tree),
        )
        .route(
            "/trees/:tree_id/research-queries/:query_id/executions",
            get(handlers::external_research::list_executions_tree),
        )
        .route(
            "/trees/:tree_id/research-queries/:query_id/results",
            get(handlers::external_research::list_results_tree),
        )
        .route(
            "/trees/:tree_id/research-results/:result_id",
            get(handlers::external_research::get_result_tree),
        )
        .route(
            "/trees/:tree_id/research-tasks/:task_id/research-queries",
            get(handlers::external_research::list_queries_for_task_tree)
                .post(handlers::external_research::create_query_for_task_tree),
        )
        .route(
            "/research-tasks/:task_id/research-queries",
            post(handlers::external_research::create_query_for_task),
        )
        .route(
            "/research-queries",
            get(handlers::external_research::list_queries_generic),
        )
        .route(
            "/research-queries/:query_id",
            get(handlers::external_research::get_query_generic)
                .delete(handlers::external_research::delete_query_generic),
        )
        .route(
            "/research-queries/:query_id/run",
            post(handlers::external_research::run_query_generic),
        )
        .route(
            "/research-queries/:query_id/executions",
            get(handlers::external_research::list_executions_generic),
        )
        .route(
            "/research-queries/:query_id/results",
            get(handlers::external_research::list_results_generic),
        )
        .route(
